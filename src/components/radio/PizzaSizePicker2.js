...
const RadioLabel = ({ thisValue, checkedValue, changeHandler, children, icon }) => {
  ...
  return (
    ...
    //   />
    //   {Children && <Children isActive={isChecked}>}
...
class PizzaSizePicker2 extends React.Component {
  constructor() {
    super()
...
export default PizzaSizePicker2
